...
Car::Car()
{
    ...
    car[0] = new Circle({-0.2f, 0.0f}, 0.07f, 1, 0.55f, 0.55f);
    car[1] = new Circle({0.2f, 0.0f}, 0.07f, 1, 0.55f, 0.55f);
    car[2] = new Rect({-0.3f, 0.0f}, {0.3f, 0.2f}, 0.89f, 0.89f, 0.31f);
    car[3] = new Trapezium({-0.28f, 0.4f}, {-0.3f, 0.2f}, 0.4f, 0.6f, 0.55f, 0.55f, 1);
}
